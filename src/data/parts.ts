...
export const PARTS_CONFIG: PartConfig[] = [
  ...
  },
  {
    ...
    model: { type: "glb", url: "/models/talaria.frame.glb", label: "Talaria Sting R",
...

  {
    ...
    specs: { mount_type: "talaria" },
    model: { type: "glb", url: "/models/sotionmotor.glb", label: "Sotion Motor",
  ...
  },
  {
    ...
    specs: { mount_type: "sur-ron" },
    model: { type: "glb", url: "/models/kofactoryspecmotor.glb", label: "KO Factory Spec",
